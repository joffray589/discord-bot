...
var GuildContext = /** @class */ (function () {
    ...
    GuildContext.prototype.isCommandEnabled = function (keyword) {
        return this._enabledCommands.has(keyword);
    };
    GuildContext.prototype.enableCommand = function (keyword) {
        this._enabledCommands.add(keyword);
    };
    GuildContext.prototype.disableCommand = function (keyword) {
